...
// }
var size = parseInt(readline.question('Enter the size of arrays: '));
function read2DArray(size, arrayNumber) {
    var array = [];
    console.log("Enter the values of array ".concat(arrayNumber, ":"));
    for (var i = 0; i < size; i++) {
        var row = readline.question().split(' ').map(Number);
        array.push(row);
    }
    return array;
}
var array1 = read2DArray(size, 1);
var array2 = read2DArray(size, 2);
var sumArray = [];
for (var i = 0; i < size; i++) {
    var row = [];
...
for (var _i = 0, sumArray_1 = sumArray; _i < sumArray_1.length; _i++) {
    var row = sumArray_1[_i];
